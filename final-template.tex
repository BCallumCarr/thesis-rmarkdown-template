...
Shepherd (2011), Spaull (2013, p. 33) or with multiple authors like
this: (Van der Berg, 2007 \& Hanushek (2010)) (the mulitple author
layout does need some fixing).
...
\begin{center}\includegraphics[width=0.4\linewidth]{final-template_files/figure-latex/unnamed-chunk-2-1} \end{center}
...
\subsection{Table Subsection}\label{table-subsection}
...
\subsection{Longtable Subsection}\label{longtable-subsection}
...
\textbf{References} heading, and before the Appendix (at least until I
fix it). Also note how, compared to something like Microsoft Word, you
don't have to worry about each reference's format, or about
alphabetizing them - everything is done automatically via Latex and the
\texttt{ref.bib} file in the \texttt{tex} folder. \color{black}

\hypertarget{refs}{}
\hypertarget{ref-Hanushek2010}{}
Hanushek, E. A. (2010) `The Difference is Great Teachers', in
\emph{Waiting for `superman': How we can save america's failing public
schools}, pp. 81--102.

\hypertarget{ref-Shepherd2011}{}
Shepherd, D. L. (2011) `Constraints to school effectiveness: what
prevents poor schools from delivering results?', \emph{Stellenbosch
Economic Working Papers}, pp. 1--37.
...
Elsevier Ltd, 33, pp. 436--447. doi:
\href{https://doi.org/10.1016/j.ijedudev.2012.09.009}{10.1016/j.ijedudev.2012.09.009}.

\hypertarget{ref-vanderBerg2007}{}
Van der Berg, S. (2007) `Apartheid's Enduring Legacy: Inequalities in
Education', \emph{Journal of African Economies}, 16(5), pp. 849--880.
doi: \href{https://doi.org/10.1093/jae/ejm017}{10.1093/jae/ejm017}.
