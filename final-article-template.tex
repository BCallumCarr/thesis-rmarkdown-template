...
\textbf{References} heading (at least until I fix it). Also not how,
compared to something like Microsoft Word, you don't have to worry about
their format, or about alphabetizing them - everything is done
automatically via Latex and the \texttt{ref.bib} file in the
